...
HFA/ASMrc は、階層構造を前提に、ソフトウェアやハードウェアの設計を 極端に簡潔な表現で扱う 個人発想（作成者：大野実）のフレームワークであり、
HFA/ASMrc はプログラムや設計の “意味” を最小単位で扱い、状態遷移や副作用を明確に定義することで、異なる言語やシステム間での 比較・解析を可能にする思考実験的仕様 でもあります。
